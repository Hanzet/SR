        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Editar Registro</h4>
                </div>
                <div class="card-body">
                    <form class="row gy-1" method="POST" action="{{ route('usuarios.update', $usuario->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control" @error('nombres') is-invalid @enderror id="nombres" name="nombres" value="{{  old('nombres', $usuario->nombres) }}" required autofocus>
                                @error('nombres')
